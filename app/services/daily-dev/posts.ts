...
import type {DailySingleResponse, DailyPostDetail, DailyCollectionResponse, DailyComment} from '../../lib/types';
...
export async function getPost(postId: string): Promise<DailySingleResponse<DailyPostDetail>> {
